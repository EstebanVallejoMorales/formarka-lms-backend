        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LearningObjectives = table.Column<List<string>>(type: "jsonb", nullable: false),
                    Features = table.Column<List<CourseFeature>>(type: "jsonb", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Entrepreneurships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Entrepreneurships_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deliverables_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deliverables_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliverables_LessonId",
                table: "Deliverables",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_Deliverables_StudentId",
                table: "Deliverables",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entrepreneurships_StudentId",
